package com.andry.recyclerview
...
import com.andry.recyclerview.adapter.AdapterTeamBola
import com.andry.recyclerview.databinding.ActivityMainBinding
import com.andry.recyclerview.model.Pemain
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listPemain.add(Pemain("Karim BenzemaThibaut Courtois",R.drawable.benzema,"Penyerang","1,85 m","Lyon (Perancis)","19 Desember 1987"))
        ...
        binding.list.adapter = AdapterTeamBola(this,listPemain,object : AdapterTeamBola.OnClickListener {
            override fun detailData(item: Pemain?) {
                Dialog(this@MainActivity).apply {
                    ...
                    val tglllahir = this.findViewById<TextView>(R.id.txtTanggalLahir)
